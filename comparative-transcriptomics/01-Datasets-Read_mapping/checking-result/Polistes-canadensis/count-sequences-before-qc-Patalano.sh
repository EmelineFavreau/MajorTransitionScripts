...
thispath="/lustre/home/ucfaeef/projects/MajorTransitionScripts/comparative-transcriptomics/rnaseq-qc/Polistes-canadensis/result/qc-before-trim"
...
paste tmp/${datasetname}/${thisanalysis}/samples-list \
	tmp/${datasetname}/${thisanalysis}/number-reads-in-sample \
	> result/${datasetname}/${thisanalysis}/number-reads-in-samples

#sum the read number for the whole experiment: 269484908
