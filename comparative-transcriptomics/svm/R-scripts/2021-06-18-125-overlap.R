...
predictor_genes <- read.csv("result/20-iterations/125_common_predictor_genes",
                            sep = "", stringsAsFactors = FALSE)

# list of all orthogroups
all_orthogroups_list <- read.delim("input/Ceratina_australensis_3718_gene_orthogroups_list",
...
# list of predictor genes per species
Ceratina_australensis_predicted_gene_vec <- read.table("result/20-iterations/Ceratina_australensis_svm_predicted_gene_list_tidy",
                                                       quote="\"", comment.char="", stringsAsFactors = FALSE)

Ceratina_calcarata_predicted_gene_vec <- read.table("result/20-iterations/Ceratina_calcarata_svm_predicted_gene_list_tidy",
                                                       quote="\"", comment.char="", stringsAsFactors = FALSE)

Megalopta_genalis_predicted_gene_vec <- read.table("result/20-iterations/Megalopta_genalis_svm_predicted_gene_list_tidy",
                                                    quote="\"", comment.char="", stringsAsFactors = FALSE)

Polistes_canadensis_predicted_gene_vec <- read.table("result/20-iterations/Polistes_canadensis_svm_predicted_gene_list_tidy",
                                                   quote="\"", comment.char="", stringsAsFactors = FALSE)

Polistes_dominula_predicted_gene_vec <- read.table("result/20-iterations/Polistes_dominula_svm_predicted_gene_list_tidy",
                                                     quote="\"", comment.char="", stringsAsFactors = FALSE)

Liostenogaster_flavolineata_predicted_gene_vec <- read.table("result/20-iterations/Liostenogaster_flavolineata_svm_predicted_gene_list_tidy",
                                                   quote="\"", comment.char="", stringsAsFactors = FALSE)
...
# keep a copy as pdf
svg("SVM_3718_Upset_comparative_plot.svg")
...
upset(fromList(SVM_listInput),
      sets = c("Ceratina_australensis_SVM",
               ...
               "Polistes_canadensis_SVM"),
      order.by = "degree", keep.order = TRUE)
svglite::svglite("SVM_3718_Upset_comparative_plot.svg")
