...
# blasting 125 predictor genes (in Apis mellifera) against all nr

module load blast+/2.2.30/intel-2015-update2


# Blast
tblastn -query result/Apis_mellifera_125_predictor_genes.faa \
        -db nt \
        -out resultOnScratch/Apis_mellifera_125_predictor_genes \
        -max_target_seqs 1 \
        -outfmt 6 \
        -num_threads 8
