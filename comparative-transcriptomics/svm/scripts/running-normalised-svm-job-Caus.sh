...
Rscript R-scripts/leave-one-species-out-svm-species-normalised.R Ceratina_australensis Caus_all_regr_norm Polistes_canadensis Polistes_dominula Liostenogaster_flavolineata Ceratina_calcarata Megalopta_genalis
