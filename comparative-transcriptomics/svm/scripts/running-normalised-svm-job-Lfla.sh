...
Rscript R-scripts/leave-one-species-out-svm-species-normalised.R Liostenogaster_flavolineata Lfla_all_regr_norm Ceratina_australensis Ceratina_calcarata Megalopta_genalis Polistes_dominula Polistes_canadensis
