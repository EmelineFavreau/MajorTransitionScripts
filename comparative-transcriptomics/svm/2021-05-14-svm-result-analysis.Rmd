...
# list genes that are common to all: 141 genes
...
write.table(x = common_predictor_genes,
            file = "result/20-iterations/132_common_predictor_genes",
            quote = FALSE,
            row.names = FALSE)
...
There are 132 predictor genes that are common to all species.
...
for(gocat in goCategory_vec){
      ...
      raw_selectionGenes_file  <- "result/20-iterations/132_common_predictor_genes"
...
## Aim 3: GO Terms associated with those predictor genes
