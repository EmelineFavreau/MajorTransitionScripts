#---
#title: "SVM test on Polistes dominula, by training on bee only"
...
FileName <- "Polistes_dominula_svm_agst_bee_only_predicted_gene_list"
plotFileName <- "Polistes_dominula_svm_agst_bee_only_plot.pdf"
ErrorRateTable <- "Polistes_dominula_svm_agst_bee_only_error_rates"
#### Define SVM function
