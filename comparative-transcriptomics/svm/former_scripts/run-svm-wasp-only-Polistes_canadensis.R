#---
#title: "SVM test on Polistes canadensis, by training on wasp only"
...
this_traindata <- pheno_data %>% 
  filter(Species %in% c("Polistes dominula", "Liostenogaster flavolineata")) %>% 
...
FileName <- "Polistes_canadensis_svm_agst_wasp_only_predicted_gene_list"
plotFileName <- "Polistes_canadensis_svm_agst_wasp_only_plot.pdf"
ErrorRateTable <- "Polistes_canadensis_svm_agst_wasp_only_error_rates"
#### Define SVM function
