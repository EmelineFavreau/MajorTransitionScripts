#---
#title: "SVM test on Megalopta genalis, by training on wasp only"
...
FileName <- "Megalopta_genalis_svm_agst_wasp_only_predicted_gene_list"
plotFileName <- "Megalopta_genalis_svm_agst_wasp_only_plot.pdf"
ErrorRateTable <- "Megalopta_genalis_svm_agst_wasp_only_error_rates"
#### Define SVM function
