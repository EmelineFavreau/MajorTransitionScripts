#---
#title: "SVM test on Ceratina calcarata, by training on 5 other species"
...
FileName <- "Ceratina_calcarata_svm_predicted_gene_list"
plotFileName <- "Ceratina_calcarata_svm_plot.pdf"
ErrorRateTable <- "Ceratina_calcarata_svm_error_rates"
#### Define SVM function
