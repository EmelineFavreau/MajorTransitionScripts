#---
#title: "SVM test on Ceratina calcarata, by training on bee only"
...
this_traindata <- pheno_data %>% 
  filter(Species %in% c("Ceratina australensis", "Megalopta genalis")) %>% 
...
FileName <- "Ceratina_calcarata_svm_agst_bee_only_predicted_gene_list"
plotFileName <- "Ceratina_calcarata_svm_agst_bee_only_plot.pdf"
ErrorRateTable <- "Ceratina_calcarata_svm_agst_bee_only_error_rates"
#### Define SVM function
