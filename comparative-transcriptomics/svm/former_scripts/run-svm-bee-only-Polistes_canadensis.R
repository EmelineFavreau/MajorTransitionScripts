#---
#title: "SVM test on Polistes canadensis, by training on bee only"
...
FileName <- "Polistes_canadensis_svm_agst_bee_only_predicted_gene_list"
plotFileName <- "Polistes_canadensis_svm_agst_bee_only_plot.pdf"
ErrorRateTable <- "Polistes_canadensis_svm_agst_bee_only_error_rates"
#### Define SVM function
