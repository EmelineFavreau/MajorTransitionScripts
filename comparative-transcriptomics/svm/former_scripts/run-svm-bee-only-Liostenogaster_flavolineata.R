#---
#title: "SVM test on Liostenogaster flavolineata, by training on bee only"
...
this_traindata <- pheno_data %>% 
  filter(Species %in% c("Ceratina australensis", "Ceratina calcarata", "Megalopta genalis")) %>% 
...
FileName <- "Liostenogaster_flavolineata_svm_agst_bee_only_predicted_gene_list"
plotFileName <- "Liostenogaster_flavolineata_svm_agst_bee_only_plot.pdf"
ErrorRateTable <- "Liostenogaster_flavolineata_svm_agst_bee_only_error_rates"
#### Define SVM function
