#---
#title: "SVM test on Megalopta genalis, by training on 5 other species"
...
FileName <- "Megalopta_genalis_svm_predicted_gene_list"
plotFileName <- "Megalopta_genalis_svm_plot.pdf"
ErrorRateTable <- "Megalopta_genalis_svm_error_rates"
#### Define SVM function
