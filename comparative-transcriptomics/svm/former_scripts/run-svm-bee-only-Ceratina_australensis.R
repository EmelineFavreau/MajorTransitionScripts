#---
#title: "SVM test on Ceratina australensis, by training on bee only"
...
this_traindata <- pheno_data %>% 
  filter(Species %in% c("Ceratina calcarata", "Megalopta genalis")) %>% 
...
FileName <- "Ceratina_australensis_svm_agst_bee_only_predicted_gene_list"
plotFileName <- "Ceratina_australensis_svm_agst_bee_only_plot.pdf"
ErrorRateTable <- "Ceratina_australensis_svm_agst_bee_only_error_rates"
#### Define SVM function
