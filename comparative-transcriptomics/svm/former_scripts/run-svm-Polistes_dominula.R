#---
#title: "SVM test on Polistes dominula, by training on 5 other species"
...
FileName <- "Polistes_dominula_svm_predicted_gene_list"
plotFileName <- "Polistes_dominula_svm_plot.pdf"
ErrorRateTable <- "Polistes_dominula_svm_error_rates"
#### Define SVM function
