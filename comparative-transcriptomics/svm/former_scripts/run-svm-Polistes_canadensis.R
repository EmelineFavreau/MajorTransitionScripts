#---
#title: "SVM test on Polistes canadensis, by training on 5 other species"
...
FileName <- "Polistes_canadensis_svm_predicted_gene_list"
plotFileName <- "Polistes_canadensis_svm_plot.pdf"
ErrorRateTable <- "Polistes_canadensis_svm_error_rates"
#### Define SVM function
