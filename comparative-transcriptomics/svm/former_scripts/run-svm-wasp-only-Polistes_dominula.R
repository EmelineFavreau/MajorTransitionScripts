#---
#title: "SVM test on Polistes dominula, by training on wasp only"
...
this_traindata <- pheno_data %>% 
  filter(Species %in% c("Polistes canadensis", "Liostenogaster flavolineata")) %>% 
...
FileName <- "Polistes_dominula_svm_agst_wasp_only_predicted_gene_list"
plotFileName <- "Polistes_dominula_svm_agst_wasp_only_plot.pdf"
ErrorRateTable <- "Polistes_dominula_svm_agst_wasp_only_error_rates"
#### Define SVM function
