#---
#title: "SVM test on Liostenogaster flavolineata, by training on 5 other species"
...
FileName <- "Liostenogaster_flavolineata_svm_predicted_gene_list"
plotFileName <- "Liostenogaster_flavolineata_svm_plot.pdf"
ErrorRateTable <- "Liostenogaster_flavolineata_svm_error_rates"
#### Define SVM function
