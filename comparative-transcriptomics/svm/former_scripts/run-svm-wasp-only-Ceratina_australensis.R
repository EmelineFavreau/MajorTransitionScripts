#---
#title: "SVM test on Ceratina australensis, by training on wasp only"
...
FileName <- "Ceratina_australensis_svm_agst_wasp_only_predicted_gene_list"
plotFileName <- "Ceratina_australensis_svm_agst_wasp_only_plot.pdf"
ErrorRateTable <- "Ceratina_australensis_svm_agst_wasp_only_error_rates"
#### Define SVM function
