#---
#title: "SVM test on Ceratina australensis, by training on 5 other species"
...
FileName <- "Ceratina_australensis_svm_predicted_gene_list"
plotFileName <- "Ceratina_australensis_svm_plot.pdf"
