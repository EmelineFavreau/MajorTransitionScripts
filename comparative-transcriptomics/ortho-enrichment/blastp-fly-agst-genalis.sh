...
# blasting proteins of Megalopta_genalis against Drosophila proteins

module load blast+/2.2.30/intel-2015-update2


# Blast species against fly
blastp -query inputOnScratch/Megalopta_genalis-longest-isoforms.faa \
	-db inputOnScratch/Drosophila_melanogaster.faa \
	-out resultOnScratch/Megalopta_genalis \
	-max_target_seqs 1 \
	-outfmt 6 \
	-num_threads 8