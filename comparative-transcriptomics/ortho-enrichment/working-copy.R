...
# import data
# the script will be as follow
# Rscript makeGOTermsTable.R this_species this_data_subset this_goCategory raw_results_file raw_selectionGenes_file raw_blast_results_file
# Rscript makeGOTermsTable.R Ceratina_australensis R BP 
# inputOnScratch/Ceratina_australensis_DESeq2_results.txt inputOnScratch/Ceratina_australensis_upR_DEGs.txt resultOnScratch/Ceratina_australensis_filtered

# set experiment details (species, upregulated in Reproductives or NonReproductives)
this_species     <- "Polistes_dominula"
this_data_subset <- "R"
this_goCategory  <- "BP"
...
raw_blast_results$qseqid <- hash_df$gene[match(raw_blast_results$qseqid, hash_df$qseqid)]
