...
# import file
Apis_proteins_orthogroups_raw <- read.delim("~/Apis_proteins_orthogroups_raw",
                                            header=FALSE,
                                            stringsAsFactors = FALSE)

# currently one line per orthorgoup (column one)
# on column two, names of Apis protein related to these orthogroups 
...
Apis_proteins_orthogroups <- Apis_proteins_orthogroups_raw[Apis_proteins_orthogroups_raw$protein_names != "", ]

# make a vector of all proteins
Apis_proteins_vec <- Apis_proteins_vec <- unlist(strsplit(Apis_proteins_orthogroups_raw$protein_names, ", "))
...
# check result
# summary(protein_orthogroup_df)
# head(protein_orthogroup_df)
# tail(protein_orthogroup_df)
