...
# blasting proteins of Ceratina calcarata against Drosophila proteins

module load blast+/2.2.30/intel-2015-update2


# Blast species against fly
blastp -query inputOnScratch/Ceratina_calcarata-longest-isoforms.faa \
	-db inputOnScratch/Drosophila_melanogaster.faa \
	-out resultOnScratch/Ceratina_calcarata \
	-max_target_seqs 1 \
	-outfmt 6 \
	-num_threads 8