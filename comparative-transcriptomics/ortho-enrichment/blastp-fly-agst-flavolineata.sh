...
# blasting proteins of Liostenogaster_flavolineata against Drosophila proteins

module load blast+/2.2.30/intel-2015-update2


# Blast species against fly
blastp -query inputOnScratch/Liostenogaster_flavolineata-longest-isoforms.faa \
	-db inputOnScratch/Drosophila_melanogaster.faa \
	-out resultOnScratch/Liostenogaster_flavolineata \
	-max_target_seqs 1 \
	-outfmt 6 \
	-num_threads 8