---
title: "TopGO in WGCNA consensus"
...
Read count from all species' reproductives and non-reproductives were input to WGCNA (consensus method). As a result, lists of orthogroups with genes in significant modules are here for input to topGO.

Here we compare significant genes to the background 3,718 genes.

---
# Objective of analysis

## Analysis steps:
- Aim 1: GO Terms associated with consensus WGCNA module size 30, all species
- Aim 2: GO Terms associated with consensus WGCNA module size 30, wasps
- Aim 3: GO Terms associated with consensus WGCNA module size 30, bees
- Aim 4: GO Terms associated with consensus WGCNA module size 10, all species
- Aim 5: GO Terms associated with consensus WGCNA module size 10, wasps
- Aim 6: GO Terms associated with consensus WGCNA module size 10, bees
...
```{r aim 1: 30 all, eval = TRUE, echo = FALSE, include = TRUE}
...
for(gocat in goCategory_vec){
      ...
      # raw_selectionGenes_file  <- "../input/module_size_10/wasps/gene_list_tidy"
      # raw_selectionGenes_file  <- "../input/module_size_10/bees/gene_list_tidy"
      this_file_name <- paste("../result/module_size_30/all/topgo_result",
                              this_goCategory,
                              sep = "_")
      # save table
...
```{r aim 2: 30 wasps, eval = TRUE, echo = FALSE, include = TRUE}
...
for(gocat in goCategory_vec){
      ...
      # make a file name
      this_file_name <- paste("../result/module_size_30/wasps/topgo_result",
                              this_goCategory,
                              sep = "_")
      # save table
      write.table(x          = myTable,
...
```{r aim 3: 30 bees, eval = TRUE, echo = FALSE, include = TRUE}
...
```{r aim 4: 10 all, eval = TRUE, echo = FALSE, include = TRUE}
...
```{r aim 5: 10 wasps, eval = TRUE, echo = FALSE, include = TRUE}
...
```{r aim 6: 10 bees, eval = TRUE, echo = FALSE, include = TRUE}
...
```{r saving object for revigo figure, eval = FALSE, echo = FALSE, include = FALSE}
...
saveRDS(gene2go_for_revigo_fig, "../input//gene2go_for_revigo_fig.rds")
saveRDS(raw_selectionGenes_for_revigo_fig,
        "../input/raw_selectionGenes_for_revigo_fig.rds")
saveRDS(myTable_for_revigo_fig,
        "../input/myTable_for_revigo_fig.rds")
saveRDS(PredictorGenes_for_revigo_fig,
        "../input/PredictorGenes_for_revigo_fig.rds")
```
