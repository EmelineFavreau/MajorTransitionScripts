...
thispath="/lustre/home/ucfaeef/projects/MajorTransitionScripts/comparative-transcriptomics/rnaseq-qc/Polistes-dominula/result/Standage/qc-before-trim"
...
# dataset name
datasetname="Standage-filtering-qc"
...
#sum the read number for the whole experiment: 1481381490
