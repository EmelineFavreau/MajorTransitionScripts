...
thispath="/lustre/home/ucfaeef/projects/MajorTransitionScripts/comparative-transcriptomics/rnaseq-qc/Polistes-dominula/result/Standage/qc-after-trim"
...
#sum the read number for the whole experiment: 
