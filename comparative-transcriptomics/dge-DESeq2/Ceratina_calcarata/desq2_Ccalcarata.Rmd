...
## Import data
hymn <- read.table("Ccalcarata_merged_gene_counts.txt", header = T, sep = "\t")
...
#names(hymn)
colnames(hymn) <- c( "SRR13281991",  "SRR13282009",  "SRR13282003",  "SRR13282004",  "SRR13282007",  "SRR13281986",  "SRR13282000",  "SRR13281984",  "SRR13282011", "SRR13281989", "SRR13281980", "SRR13282008", "SRR13281979", "SRR13281985", "SRR13281987", "SRR13282005", "SRR13281993", "SRR13282010", "SRR13281988", "SRR13282002", "SRR13281995", "SRR13281983", "SRR13281994", "SRR13281992", "SRR13282001", "SRR13281981", "SRR13281982", "SRR13281997", "SRR13281999", "SRR13281996", "SRR13282006", "SRR13281998", "SRR13281990")
dim(hymn)

## At the moment, we have more samples than desired for repro vs. nonrepro. So, let's just grab the columns we want:
hymn <- hymn[,c("SRR13281988", "SRR13281982", "SRR13281995", "SRR13282007", "SRR13281993", "SRR13282006")]
#names(hymn)
...
## Read count by phenotype (first 3 are R's, second 3 are NR's)
sum(hymn[,c(1:3)])
sum(hymn[,c(4:6)])
...
```{r}
id <- c("SRR13281988", "SRR13281982", "SRR13281995", "SRR13282007", "SRR13281993", "SRR13282006")
...
```
Some Rs and non are quite dissimilar, but the reproductive phenotypes don't cluster distinctly. The NR phenotypes do.
...
pheatmap(pwCorr)
```
There is better clustering than we've seen in some of the other species despite the small sample sizes except that one mother (reproductive) who is just different from everybody else...
...
plotCounts(dds, gene="Ccalc.v2_003400", intgroup="phenotype")
plotCounts(dds, gene="Ccalc.v2_004788", intgroup="phenotype")
plotCounts(dds, gene="Ccalc.v2_011506", intgroup="phenotype")
```
