...
predictor_genes <- 
  read.csv("../svm/result/species-normalised/regression-on-all/127_common_predictor_genes",
...
There is little overlap between the three genes sets. 
Two genes are common to all three:  "OG0000706" (uncharacterized protein LOC408365 isoform X2 [Apis mellifera]) and "OG0001935" (uncharacterized protein LOC408661 isoform X1 [Apis mellifera]).
