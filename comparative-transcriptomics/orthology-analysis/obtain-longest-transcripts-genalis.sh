...
# Obtain longest transcript for  each gene in Megalopta genalis
...
cp /mnt/gpfs/live/rd01__/ritd-ag-project-rd011y-eefav92/Megalopta-genalis/gff/GCF_011865705.1_USU_MGEN_1.2_genomic.gff.gz .

mv GCF_011865705.1_USU_MGEN_1.2_genomic.gff.gz Megalopta_genalis.gff.gz
exit 

thisspecies="Megalopta_genalis"
...
# get gene and protein IDs from GFF file, e.g.117217331	XP_033324778.1
