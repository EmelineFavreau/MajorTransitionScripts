...
cp /mnt/gpfs/live/rd01__/ritd-ag-project-rd011y-eefav92/Ceratina_autralensis/Ceratina_australensis_2019/gff/australensis.MAKER_run_v1.cfig_v5.MAKER_ONLY_FORMATTED.gff.filtered.gz .

mv australensis.MAKER_run_v1.cfig_v5.MAKER_ONLY_FORMATTED.gff.filtered.gz Ceratina_australensis.gff.gz
...
zcat inputOnScratch/gff/${thisspecies}.gff.gz | grep "gene" | head
...
zcat inputOnScratch/gff/${thisspecies}.gff.gz | awk '$3=="gene"{gsub("ID=", "", $9); gsub(";$", "", $9); gsub(";Name=.*;Alias=", "\t", $9); print $9}' | sort | uniq > inputOnScratch/gff/${thisspecies}.tsv
